...
const NavBar = ()=>{
    ...
    return(
        ...
        <span className="icon-menu d-block d-lg-none text-white h1 m-0" onClick={handleMenuMobile}>
            {
                showMenu ? (<FiX />) : <FiMenu />
            }
        </span>
        <nav className={`nav-bar d-flex align-items-center hide-mobile ${showMenu ? 'show' : ''}`}>
            <div className="w-100">
                <div className="logo">
