    ...
    return(
        <Container className="fadeInUp" id="contact-page">
            ...
            <Row>
                ...
                <Col lg={4}>
                    <a href="https://www.linkedin.com/in/uismalopes" rel="noopener noreferrer" target="_blank" className="d-block mb-4">
                        <Row className="text-white justify-content-center align-items-center">
                            <Col lg={4}>
                                <span className="icon rounded-circle d-flex align-items-center justify-content-center mb-2 mx-auto">
                                    <FiLinkedin />
                ...
                <Col lg={4}>
                    <a href="https://github.com/uismalopes" rel="noopener noreferrer" target="_blank" className="d-block mb-4">
                        <Row className="text-white justify-content-center align-items-center">
                            <Col lg={4}>
                                <span className="icon rounded-circle d-flex align-items-center justify-content-center mb-2 mx-auto">
                                    <FiGithub />
